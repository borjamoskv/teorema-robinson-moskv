...
VANGUARD_AGENTS = "$CORTEX_ROOT/borjamoskv/Teorema-Robinson-Moskv/vanguard-reserve/AGENTS.md"
        ...
        for line in f:
            ...
            if line.startswith("### "):
                ...
                if match:
                    ...
                    if desc.startswith(":"): desc = desc[1:].strip()
                    data[current_section].append({"id": id_, "name": name, "description": desc})
    ...
    with open(path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            if line.startswith("### "):
                ...
                current_synergy = {"title": line.replace("### ", "").strip(), "details": {}}
