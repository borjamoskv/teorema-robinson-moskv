...
def main():
    ...
    payload = {'word': word, 'character': char, 'count': count, 'reality_level': 'C5-REAL', 'verifier': 'Physical CPU Core'}
    ...
    receipt = {'receipt_id': f'rec_{hashlib.md5(canonical_payload).hexdigest()[:8]}', 'schema': 'https://schema.babylon60.dev/v0.2/character-attestation', 'payload': payload, 'payload_hash': payload_hash, 'signature': {'algorithm': 'Ed25519', 'key_id': did_key, 'value': sig_b64}}
