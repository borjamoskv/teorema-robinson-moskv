...
output_file = "/Users/borjafernandezangulo/30_BABYLON-60/scratch/600_analysis_report.md"

def analyze_transcripts():
    results = []
    
    # Use glob to find all transcript.jsonl files
    ...
    report_lines = [
        ...
        f"**Total de Muestras (Prompts 'QUE SABES QUE sí sabes?'):** {stats_total}",
        f"**Vector ULTRATHINK:** {stats_ultra}",
        f"**Vector Estándar:** {stats_no_ultra}",
        "---",
