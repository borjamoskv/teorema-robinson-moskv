...
md_file = "$CORTEX_ROOT/30_BABYLON-60/cortex/agents/ontology/osint_primitives_matrix.md"
target_db = "$CORTEX_ROOT/30_BABYLON-60/cortex/agents/ontology/osint_primitives.db"
