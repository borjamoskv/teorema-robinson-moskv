...
En [MaxRouterAnchor.sol](file:///Users/borjafernandezangulo/30_BABYLON-60/contracts/MaxRouterAnchor.sol#L57-L77), la función `anchorBatch` delega la confianza de manera exclusiva en el rol del atestador (`onlyAttester`):
