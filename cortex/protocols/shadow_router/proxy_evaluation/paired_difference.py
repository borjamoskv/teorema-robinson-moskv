...
def estimate_shadow_proxy_difference(
    paired_differences_basis_points: np.ndarray,
    shadow_inclusion_indicators: np.ndarray,
    shadow_inclusion_propensities_basis_points: np.ndarray,
    confidence_level_basis_points: int = 9500,
    ...
    ci_lower = np.percentile(
        boot_estimates, (10000 - confidence_level_basis_points) / 200.0
    )
