...
def create_ttft_measurement(
    request_started_at_ns: int,
    first_byte_at_ns: int,
    first_content_token_at_ns: Optional[int],
    completed_at_ns: int,
    streaming_enabled: bool,
) -> TTFTMeasurement:
    """
    Creates and validates a TTFTMeasurement following strict temporal invariants.
    """
    ...
    ttfb_ms = int((first_byte_at_ns - request_started_at_ns) / 1_000_000)
    total_latency_ms = int((completed_at_ns - request_started_at_ns) / 1_000_000)
    ...
    if streaming_enabled:
        ...
        ttft_ms = int((first_content_token_at_ns - request_started_at_ns) / 1_000_000)
    ...
    return TTFTMeasurement(
        ...
        first_byte_at_ns=first_byte_at_ns,
        first_content_token_at_ns=first_content_token_at_ns,
