import sys
import yaml
LEXICON = {'📢': 'PRE_PREPARE', '🛡️': 'PREPARE', '✅': 'COMMIT_ACK', '❌': 'NACK_REJECT', '📦': 'SYS_RECV', '🧠': 'SYS_PROCESS', '⚡': 'SYS_OK', '📤': 'SYS_SEND', '💀': 'SYS_FATAL', '🩸': 'SYS_ROLLBACK', '🔒': 'SYS_LOCK', '🔓': 'SYS_UNLOCK', '⏳': 'SYS_WAIT', '🔄': 'VIEW_CHANGE', '👑': 'NEW_VIEW'}
TRANSITIONS = {'📢': ['🛡️', '📦'], '🛡️': ['✅', '⏳'], '✅': ['📤', '🧠'], '❌': ['💀'], '📦': ['🔒'], '🧠': ['⚡', '🩸', '⏳'], '⚡': ['📤', '✅', '📢'], '🩸': ['📦', '🔄'], '💀': ['🔄', '❌'], '🔒': ['🔓'], '🔓': ['🧠'], '⏳': ['🧠', '💀'], '🔄': ['👑', '⏳'], '👑': ['📢'], '📤': []}
...
def export_yaml():
    data = {'Ontology': 'ECB-1_PBFT_Matrix', 'Entities': LEXICON, 'Transitions': TRANSITIONS}
