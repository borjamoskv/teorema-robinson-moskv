...
if __name__ == '__main__':
    ...
    test_vectors = [('Flujo Nominal PBFT', '📢📦🧠⚡✅🔒📤'), ('Flujo Nominal + Commit', '📢📦🛡️✅🔒📤'), ('Flujo de View Change', '💀❌🔄👑📢📦🧠⚡✅🔒📤'), ('Flujo de Rollback', '📦🧠⏳💀🩸🧠⚡✅🔒📤'), ('Falla: Cortocircuito Ilegal', '📢📦⏳💀📤'), ('Falla: Salto Cuántico', '🧠📤'), ('Falla: Token Inyectado', '📢📦🧠X⚡')]
