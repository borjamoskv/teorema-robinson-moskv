...
class AcousticKernel:
    ...
    async def process_loop(self):
        while True:
            ...
            async with self._mutex:
                ...
                self.ledger.log_acoustic_event(self.session_id, frame_hash[:16], tensor_hash[:16], pcm_hash[:16], ttft, ttfaf)
    ...
    async def _tensor_inference(self, pcm_frame: bytes):
        ...
        result = mlx_whisper.transcribe(temp_wav, path_or_hf_repo='mlx-community/whisper-tiny')
