...
```mermaid
graph TD
    subgraph "El Bucle Infinito (OUROBOROS)"
        direction TB
        
        L0["👁️ L0 — Percepción (Escáner + Arqueología + Modelos)"]
        L1["💡 L1 — Comprensión (Motor Causal + Entropía)"]
        L2["🗡️ L2 — Estrategia (Consejo de Guerra + Red Team)"]
        L3["⚡ L3 — Ejecución (Enjambre + Auto-Curación)"]
        L4["🪞 L4 — Meta-Cognición (Reflexión + CORTEX)"]
        L5["🧬 L5 — Autopoiesis (Absorción + Auto-Mutación)"]

        L0 --> L1 --> L2 --> L3 --> L4 --> L5
    end

    L5 ===>|"EL BUCLE DEVORA SU COLA (Reescribe SKILL.md)"| L0

    style L0 fill:#7209b7,color:#fff
    style L1 fill:#4361ee,color:#fff
    style L2 fill:#f72585,color:#fff
    style L3 fill:#06d6a0,color:#fff
    style L4 fill:#ff6b35,color:#fff
    style L5 fill:#d00000,color:#fff,stroke:#fff,stroke-width:3px
