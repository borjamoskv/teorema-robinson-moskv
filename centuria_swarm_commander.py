...
WORKSPACE = os.environ.get(
    "BABYLON_WORKSPACE", os.path.dirname(os.path.abspath(__file__))
)
SHARDS_FILE = os.path.join(WORKSPACE, "shards.json")


def generate_100_vectors() -> list:  # type: ignore
    ...
    vectors.extend(
        [
            {
                "type": "DB_Schema",
                "target": "L1_primitive_nodes",
                "directive": "Verify indexing and constraint rigor.",
            },
            {
                "type": "DB_Schema",
