...
from kernel.bft_strict import ASTLintNode, IntegrityNode, MutationPayload, TestNode, ValidatorNode, QUORUM, validate_mutation, _verify_attestation
...
def _payload(src: bytes, falsification=lambda: True, digest=None, ct='python'):
    return MutationPayload(diff=src, author='test', timestamp='2026-07-12T00:00:00Z', declared_digest=digest or sha256_bytes(src), content_type=ct, falsification=falsification)
