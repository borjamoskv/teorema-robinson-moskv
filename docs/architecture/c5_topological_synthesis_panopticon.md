...
- **Inyección en OS:** Despliegue como *Launch Daemon* (`/Library/LaunchDaemons/com.moskv.panopticon.plist`), arrancando directamente en el *boot* de XNU bajo los privilegios del superusuario (Ring-0 equivalente en mach).
