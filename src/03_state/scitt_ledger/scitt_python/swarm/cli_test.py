...
"""
Unit tests for C5-REAL Sovereign Swarm CLI (larsa/swarm/cli.py).
"""
...
def test_swarm_cli_kill_unkill(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    try:
        # Test kill
        test_args_kill = ["larsa/swarm/cli.py", "kill"]
        ...
        # Test unkill
        test_args_unkill = ["larsa/swarm/cli.py", "unkill"]
