...
1. [haskell_1000_taxonomy.yaml](file:///Users/borjafernandezangulo/borjamoskv/Teorema-Robinson-Moskv/larsa/ontology/haskell_1000_taxonomy.yaml): Especificación ontológica canónica.
...
6. [haskell_1000.py](file:///Users/borjafernandezangulo/borjamoskv/Teorema-Robinson-Moskv/larsa/haskell_1000.py): Simulador en Python.
7. [haskell_1000_test.py](file:///Users/borjafernandezangulo/borjamoskv/Teorema-Robinson-Moskv/larsa/haskell_1000_test.py): Suite de pruebas unitarias Python (100% Cobertura).
...
- **Python Test Suite (`python3 -m unittest larsa/haskell_1000_test.py`)**:
