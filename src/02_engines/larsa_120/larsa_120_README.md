...
**Motor de Ejecución de IA, Memoria Determinista (larsa-persist) y Orquestación**

El núcleo de infraestructura de agentes de Inteligencia Artificial del ecosistema Teorema-Robinson-Moskv.

## Módulos del Sistema
- **`src/babylon-60/`**: Frontend IDE Visual larsa con renderizado reactivo y telemetría de memoria compartida.
