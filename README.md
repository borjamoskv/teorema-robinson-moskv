...
| :--- | :--- | :--- |
| **`start.sh`** | Socket Sanitizer & Node.js Initiator | [start.sh](file:///Users/borjafernandezangulo/30_BABYLON-60/start.sh) |
| **`server.js`** | REST Endpoint / WS Telemetry | [server.js](file:///Users/borjafernandezangulo/30_BABYLON-60/server.js) |
| **`cortex_inference.py`** | 7-Mode Graph Retrieval Engine | [cortex_inference.py](file:///Users/borjafernandezangulo/30_BABYLON-60/cortex_inference.py) |
| **`scientific_engine.py`** | Math Solvers (Shannon, Fisher, MDL) | [scientific_engine.py](file:///Users/borjafernandezangulo/30_BABYLON-60/scientific_engine.py) |
| **`analysis.py`** | FastAPI JWT REST | [cortex/api/analysis.py](file:///Users/borjafernandezangulo/30_BABYLON-60/cortex/api/analysis.py) |
| **`matriz_1000...`** | 10 Theories → 1000 Primitives | [matriz_1000_primitivas.yaml](file:///Users/borjafernandezangulo/30_BABYLON-60/matriz_1000_primitivas.yaml) |
| **`isomorfismos...`** | 120 Structural Edges | [isomorfismos_cruzados_1000_primitivas.yaml](file:///Users/borjafernandezangulo/30_BABYLON-60/isomorfismos_cruzados_1000_primitivas.yaml) |
| **`cortex_inference_...`**| 7 Inference Modes Config | [cortex_inference_engine.yaml](file:///Users/borjafernandezangulo/30_BABYLON-60/cortex_inference_engine.yaml) |
| **`antigravity_...`** | 4-Layer Schema | [antigravity_memory_schema.yaml](file:///Users/borjafernandezangulo/30_BABYLON-60/antigravity_memory_schema.yaml) |
| **`Robinson_Moskv...`** | Ω2 Context Rot Invariant | [Robinson_Moskv_Invariant.md](file:///Users/borjafernandezangulo/30_BABYLON-60/Robinson_Moskv_Invariant.md) |
| **`cortex_substack...`**| Substack Mafia Behavior Audit | [cortex_substack_mafia_audit.md](file:///Users/borjafernandezangulo/30_BABYLON-60/cortex_substack_mafia_audit.md) |
| **`FORENSIC_REPORT.md`**| Static Analysis Scorecard | [FORENSIC_REPORT.md](file:///Users/borjafernandezangulo/30_BABYLON-60/FORENSIC_REPORT.md) |
| **`AGENTS.md`** | C5-REAL Kernel Invariants | [AGENTS.md](file:///Users/borjafernandezangulo/30_BABYLON-60/AGENTS.md) |
| **`test_cortex...`** | Inference Unit Tests | [test_cortex_inference.py](file:///Users/borjafernandezangulo/30_BABYLON-60/test_cortex_inference.py) |
| **`test_scientific...`**| Solvers Unit Tests | [test_scientific_engine.py](file:///Users/borjafernandezangulo/30_BABYLON-60/test_scientific_engine.py) |
