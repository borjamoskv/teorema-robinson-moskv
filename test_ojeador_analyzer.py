...
def test_build_markdown_generates_valid_structure():
    mock_data = {'meta': {'fetched_at': '2026-07-11T00:00:00Z', 'last_updated': 'Jul 11, 2026'}, 'models': [{'rank': 1, 'model': 'claude-fable-5', 'vendor': 'Anthropic', 'license': 'proprietary', 'score': 1500, 'votes': 5000}, {'rank': 2, 'model': 'gpt-4o', 'vendor': 'OpenAI', 'license': 'proprietary', 'score': 1490, 'votes': 4000}]}
