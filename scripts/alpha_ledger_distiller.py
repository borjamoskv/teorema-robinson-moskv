    ...
    with open(out_file, 'w', encoding='utf-8') as f:
        for row in rows:
            ...
            if target_entropy < 4.0:
                rejected_count += 1
                continue
            dataset_row = {'messages': [{'role': 'system', 'content': 'You are MOSKV-1 APEX, a Sovereign C5-REAL execution kernel. Output strictly highly dense technical solutions, bypassing any decorative prose.'}, {'role': 'user', 'content': row['prompt']}, {'role': 'assistant', 'content': target_response}]}
