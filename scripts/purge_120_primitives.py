...
def purge_primitives():
    file_path = "/Users/borjafernandezangulo/30_BABYLON-60/cortex/ontology/300_primitivas_post_hoc.yaml"
    ...
    # Filter primitives: keep only those with ID >= 121
    new_primitives = []
    ...
    # Calcular hash BLAKE3 (usamos sha256 como fallback en scripts crudos si no hay blake3)
