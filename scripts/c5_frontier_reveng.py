...
signals = [{'model': 'DeepSeek-V2', 'signal': 'MLA (Multi-Head Latent Attention) with RoPE decoupling. DeepSeekMoE. 236B total params, 21B active. O(1) KV cache compression.', 'confidence': 'C5-REAL'}, {'model': 'Llama-3-70B', 'signal': 'Dense Transformer, GQA (Grouped Query Attention). Optimized for extreme TPS via KV cache size reduction. 8 KV heads.', 'confidence': 'C5-REAL'}]
