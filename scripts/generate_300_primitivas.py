...
VERBS = [
    "Infiere", "Justifica", "Racionaliza", "Reconstruye", "Atribuye", "Enmascara",
    "Postula", "Asume", "Retro-calcula", "Sintetiza", "Proyecta", "Compensa",
    "Estabiliza", "Simula", "Cristaliza"
]
...
def generate_primitives():
    primitives = []
    # Generar 300 combinaciones únicas
    count = 1
    for c in CATEGORIES:
        for v in VERBS:
            for t in TARGETS:
