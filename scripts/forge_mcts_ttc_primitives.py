...
def generate_base_description(domain, index):
    # Map index to specific deterministic mathematical properties to avoid generic text
    seed = (index * 7) % 11
    ...
    # Add a unique suffix derived from index to ensure uniqueness across the 300 items
...
def forge_primitives():
    ...
    db_path = "/Users/borjafernandezangulo/30_BABYLON-60/cortex/ontology/mcts_ttc_matrix.db"
    ...
    for domain in DOMAINS:
        for i in range(30):
            # Deterministic uuid generation based on domain and count
    ...
    # Save YAML sidecar
    yaml_path = "/Users/borjafernandezangulo/30_BABYLON-60/cortex/ontology/300_primitivas_mcts_ttc.yaml"
