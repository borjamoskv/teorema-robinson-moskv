...
import json
import os
queries = ['all:"structural isomorphism" AND all:"representation learning"', 'all:"relational structure" AND all:"transfer" AND all:"domain"', 'all:"category theory" AND all:"neural networks"', 'all:"causal structure" AND all:"isomorphism"', 'all:"structure-mapping" AND all:"deep learning"']
papers = []
for q in queries:
