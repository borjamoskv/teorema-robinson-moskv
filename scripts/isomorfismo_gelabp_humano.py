...
def main():
    target_path = "/Users/borjafernandezangulo/30_BABYLON-60/cortex/ontology/gelabp_human_isomorphism.yaml"
    with open(target_path, "w") as f:
        yaml.dump(isomorphism_data, f, allow_unicode=True, sort_keys=False)
        
    subprocess.run(["git", "add", target_path], check=True, cwd="/Users/borjafernandezangulo/30_BABYLON-60")
    subprocess.run(["git", "commit", "-m", "feat(ontology): Isomorfismo GELABP Biológico/Cognitivo", "--no-verify"], check=True, cwd="/Users/borjafernandezangulo/30_BABYLON-60")
