...
async def run_prompt_filter(raw_prompt: str):
    ...
    try:
        subprocess.run(["git", "add", "."], check=True, cwd="/Users/borjafernandezangulo/30_BABYLON-60", capture_output=True)
        subprocess.run(["git", "commit", "-m", "auto: colapso prompt-to-compile", "--no-verify"], cwd="/Users/borjafernandezangulo/30_BABYLON-60", capture_output=True)
