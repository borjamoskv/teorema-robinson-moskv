...
wav_path = "$CORTEX_ROOT/Music/VISUALES/remotion-forge/public/friccion_acto2_dialogs.wav"
json_path = "$CORTEX_ROOT/Music/VISUALES/remotion-forge/src/volume_envelope_acto2.json"
