...
wav_path = "$CORTEX_ROOT/Music/VISUALES/remotion-forge/public/friccion_dialogs.wav"
json_path = "$CORTEX_ROOT/Music/VISUALES/remotion-forge/src/volume_envelope.json"
