---
title: "Trastorno por Superávit de Atención (TSA)"
date: 2026-05-28
category: "Patologías Cognitivas del Hiperenfoque"
...
```mermaid
graph TD
    A["Estímulo: Zapato Desatado"] --> B["Cerebro Estándar: Nudo Simple (0.5s)"]
    A --> C["Cerebro TSA: Iniciar Cálculo Topológico"]
    C --> D["Análisis de Tensión de Hilo Mínima"]
    D --> E["Optimización de Ángulo de Fricción Dinámica"]
    E --> F["Simulación de Desgaste en Ciclos de 5 Años"]
    F --> G["Resultado: El paciente lleva 45 minutos inmóvil mirando su bota."]
```
