...
MATRIZ_PATH = os.environ.get('CORTEX_MATRIZ_PATH', os.path.join(VAULT_DIR, 'matriz_1000_primitivas.yaml.enc'))
ISOMORFISMOS_PATH = os.environ.get('CORTEX_ISOMORFISMOS_PATH', os.path.join(VAULT_DIR, 'isomorfismos_cruzados_1000_primitivas.yaml.enc'))
