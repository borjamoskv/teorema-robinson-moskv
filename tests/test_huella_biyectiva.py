...
YAML_PATH = str(Path(__file__).resolve().parents[1] / 'cortex' / 'ontology' / 'huella_biyectiva_hardware.yaml')
...
def test_yaml_structure():
    ...
    required_keys = ['Claim', 'Auditoria_Epistemica', 'Topologia_Isomorfica_Borja_Moskv', 'Estructura_Resolucion_Atomica', 'Firma_Ejecucion']
